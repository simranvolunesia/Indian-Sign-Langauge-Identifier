...
cv2.createTrackbar("L - S", "Slider", 58, 255, nothing)
cv2.createTrackbar("L - V", "Slider", 30, 255, nothing)
cv2.createTrackbar("U - H", "Slider", 33, 179, nothing)
cv2.createTrackbar("U - S", "Slider", 255, 255, nothing)
cv2.createTrackbar("U - V", "Slider", 255, 255, nothing)

cv2.namedWindow("Sign Language Identifier (SLI)")
...
while True:
    ...
    cv2.imshow("Sign Language Identifier (SLI)", frame)
